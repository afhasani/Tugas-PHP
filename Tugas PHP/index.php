    ...
    <div class="form-container">
        ...
        <form action="process.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" name="email" id="email" minlength="5" required>
            </div>
            <div class="mb-3">
                <label for="phone" class="form-label">Telepon</label>
                <input type="text" class="form-control" name="phone" id="phone" minlength="8"required>
            </div>
            <div class="mb-3">
                <label for="address" class="form-label">Alamat</label>
                <textarea class="form-control" name="address" id="address" rows="4" minlength="10" required></textarea>
            </div>
            <div class="mb-3">
